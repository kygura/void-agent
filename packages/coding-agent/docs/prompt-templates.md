> void can create prompt templates. Ask it to build one for your workflow.
...
void loads prompt templates from:

- Global: `~/.void/prompts/*.md`
- Project: `.void/prompts/*.md`
- Packages: `prompts/` directories or `void.prompts` entries in `package.json`
