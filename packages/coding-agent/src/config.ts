...
export function getPackageDir(): string {
	...
	const envDir = process.env.VOID_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json voidConfig)
// =============================================================================

const pkg = JSON.parse(readFileSync(getPackageJsonPath(), "utf-8"));

export const APP_NAME: string = pkg.voidConfig?.name || "void";
export const CONFIG_DIR_NAME: string = pkg.voidConfig?.configDir || ".void";
export const VERSION: string = pkg.version;

// e.g., VOID_CODING_AGENT_DIR
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.VOID_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.void/*)
// =============================================================================

/** Get the global void config directory (default: ~/.void). */
...
/** Get path to user-level subagent definitions directory (~/.void/agents) */
export function getAgentsDir(): string {
	return join(getAgentDir(), "agents");
}

/** Get path to CLI profiles directory (~/.void/profiles/<name>.json) */
