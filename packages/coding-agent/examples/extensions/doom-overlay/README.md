...
Play DOOM as an overlay in void. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
void --extension ./examples/extensions/doom-overlay
```
