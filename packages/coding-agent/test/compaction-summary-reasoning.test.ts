...
import type * as VoidAi from "@void/ai";
import type { AssistantMessage, Model } from "@void/ai";
...
vi.mock("@void/ai", async (importOriginal) => {
	const actual = await importOriginal<typeof VoidAi>();
	return {
		...actual,
