...
Reusable web UI components for building AI chat interfaces powered by [@void/ai](../ai) and [@void/agent](../agent).
...
```bash
bun add @void/web-ui @void/agent @void/ai
```
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@void/web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@void/web-ui';
...
```typescript
import { createExtractDocumentTool } from '@void/web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@void/web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@void/web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@void/web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@void/web-ui';
...
```typescript
import { SessionListDialog } from '@void/web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@void/web-ui';
...
```typescript
import { ModelSelector } from '@void/web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@void/web-ui';
...
- [sitegeist](https://sitegeist.ai) - Browser extension using void-web-ui
