...
- [ ] `src/setup/generate-setup-script.ts` - Generate bash script as string
  ...
  - [ ] Generate env var setup (HF_TOKEN, VOID_API_KEY)
...
- [ ] `src/config/store.ts` - Read/write ~/.void/pods.json
...
- [ ] `src/commands/pods-setup.ts` - void pods setup
  - [ ] Parse args (name, ssh, mount)
  - [ ] Check env vars (HF_TOKEN, VOID_API_KEY)
  - [ ] Call setup executor
  - [ ] Save pod to config

- [ ] `src/commands/pods-list.ts` - void pods
  - [ ] Load config
  - [ ] Display all pods with active marker

- [ ] `src/commands/pods-active.ts` - void pods active
  - [ ] Switch active pod
  - [ ] Update config

- [ ] `src/commands/pods-remove.ts` - void pods remove
...
- [ ] `src/commands/start.ts` - void start
...
- [ ] `src/commands/stop.ts` - void stop
  - [ ] Find model in config
  - [ ] Kill process via PID
  - [ ] Clean up config

- [ ] `src/commands/list.ts` - void list
  - [ ] Show models from config
  - [ ] Optionally verify PIDs

- [ ] `src/commands/logs.ts` - void logs
...
- [ ] `src/commands/prompt.ts` - void prompt
