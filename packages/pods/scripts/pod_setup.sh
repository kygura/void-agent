...
# Parse arguments passed from void CLI
MOUNT_COMMAND=""
MODELS_PATH=""
HF_TOKEN=""
VOID_API_KEY=""
...
if [ -z "$VOID_API_KEY" ]; then
    echo "ERROR: VOID_API_KEY is required" >&2
    exit 1
fi
...
# --- Output GPU info for void CLI to parse -----------------------------------
echo ""
echo "===GPU_INFO_START==="
