...
Stateful agent with tool execution and event streaming. Built on `@void/ai`.
...
```typescript
import { Agent, streamProxy } from "@void/agent";
...
```typescript
import { agentLoop, agentLoopContinue } from "@void/agent";
