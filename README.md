...
| [`@void/jev`](packages/jev) | Typed client for TypeSafe's Jev System One model: calibrated Noul/Choice/Score judgements, plus a tool-call judge that backs the coding agent's `permissions.judge` auto mode |
